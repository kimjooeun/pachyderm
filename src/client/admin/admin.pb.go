...
// where auth is enabled. It verifies that the user provided the correct
// auth token for the restore before we start restoring.
...
func (m *CheckAuthToken) GetTokenHash() string {
	if m != nil {
		return m.TokenHash
	}
	return ""
...
type ExtractRequest struct {
	...
	// AuthToken is the root token that will be installed on the restored cluster
...
func (m *ExtractRequest) GetAuthToken() string {
	if m != nil {
		return m.AuthToken
	}
	return ""
...
func (m *ExtractPipelineRequest) GetPipeline() *pps4.Pipeline {
	if m != nil {
		return m.Pipeline
	}
	return nil
...
var fileDescriptor_6597bb2f2302afbd = []byte{
	...
	,
}
...
func (m *CheckAuthToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TokenHash) > 0 {
		...
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.TokenHash)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *ExtractRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AuthToken) > 0 {
		...
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.AuthToken)))
		i--
		dAtA[i] = 0x3a
	}
	if m.NoAuth {
